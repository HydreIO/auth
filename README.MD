...
- configure in `./serverless.yml` the needed `region` and `origin` fields (to accept any origin we need a custom response template but i didn't found yet how to do it with this damn framework)
